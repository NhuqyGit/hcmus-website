...
function Header() {
    ...
    return ( 
        <>
            ...
            {/* <Search isSearchClick={isSearchClick} onChangeState={handleSearchClose}/> */}
            <SearchMenu isMenuClick={isMenuClick} isClick={isClick} setWidth={setWidth} onChangeState={handleMenuClose}/>
