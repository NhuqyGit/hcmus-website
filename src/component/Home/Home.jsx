    ...
    return (
        ...
        <section className="slider-section">
            ...
            {/* <img src={banner} /> */}
                ...
                <p className="text-content-slider">Trường Đại học Khoa học Tự nhiên,<br/>Đại học Quốc gia Thành phố Hồ Chí Minh</p>
            <div className="overlay-title"></div>
            <div className="content-overlay">
                <p className="title-text">Lorem Ipsum chỉ đơn giản là một đoạn văn bản giả, được dùng vào việc trình bày và dàn trang phục vụ cho in ấn. Lorem Ipsum đã được sử dụng như một văn bản chuẩn cho ngành công nghiệp in ấn từ những năm 1500</p>
                {/* <button className="button-action-slide"><i className="icofont-ui-play"></i></button>   */}
                
                <div className='button-action-slide' onClick={()=>setPlay(!isPlay)}>
                    <svg style={{display: !isPlay ? 'block' : 'none'}} viewBox="0 0 48 48"  xmlns="http://www.w3.org/2000/svg">
                        <path d="M-838-2232H562v3600H-838z" fill="none"/><path d="M16 10v28l22-14z"/><path d="M0 0h48v48H0z" fill="none"/>
                    </svg>

                    <svg style={{display: isPlay ? 'block' : 'none'}} version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <div className="items-left">
                    <svg width="32px" height="32px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
                        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" sketch:type="MSPage">
                            <g id="icon-48-notebook" sketch:type="MSArtboardGroup" fill="#000000">
            ...
            <div className="information-tab">
                ...
                <div className="box-post-tab">
                    ...
                    <div className="box-blog-post">
                        ...
                        <p className="post-except">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sit amet lacinia eros. Etiam tincidunt enim nec turpis condimentum ultricies.</p>
                    </div>
                    <div className="box-blog-post">
                        <img src={post2} />
        ...
        <section className="award-section">
            ...
            <div className="title-row">
                ...
                <p>Ở đây, chúng tôi tự hào giới thiệu đến bạn những thành quả nghiên cứu độc đáo và sáng tạo từ các ngành khoa học tại trường chúng tôi. Từ các phát minh công nghệ tiên tiến đến các phân tích sâu sắc về tự nhiên và xã hội, chúng tôi đã đạt được những thành tựu đáng kinh ngạc</p>
                </div>
            </div>
            <div className="icon-element"> 
                ...
                <div className="icon-box">
                    ...
                    <div className="content-post">
                        <p className="title-content-post">Loại pin mặt trời mới có thể tạo nhiều hoa văn khác nhau </p>
                        <p className="except-content-post">Pin mặt trời chất màu nhạy quang vừa có thểứng dụng làm kính của các tòa nhà với nhiều loại hoa văn khác nhau, vừa cung cấp thêm nguồn điện và làm mát cho các tòa nhà.</p>
                    </div>
                    </div>
                    <div className="row-blog-post">
                    <div className="img-post">
        ...
        <section className="intro-member">
            ...
            <div className="title-row">
                ...
                <p>Ở đây, chúng tôi tự hào giới thiệu đến bạn những thành quả nghiên cứu độc đáo và sáng tạo từ các ngành khoa học tại trường chúng tôi. Từ các phát minh công nghệ tiên tiến.</p>
                </div>
            ...
            <div className="container">
                ...
                <div className="col-6-member">
                    ...
                    <p className="role-member">TRƯỞNG KHOA CÔNG NGHỆ THÔNG TIN</p>
                    <p className="name-member">TS. Đinh Bá Tiến</p>
                    <p className="intro-text-member">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged</p>
                    </div>
                    <div className="nav-member">
                        <ul>
                            <li><img src={person1} /></li>
                            <li><img src={person2} /></li>
                            <li className='active'><img src={dbt} /></li>
                            <li><img src={person4} /></li>
                            <li><img src={person5} /></li>
                        </ul>
                    </div>
                </div>
                </div>
            ...
            <div className="flex-news-post">
                ...
                <div className="box-news">
                    ...
                    <div className="content-box-news">
                        <p>Toàn quốc khoa học trái đất mỏ, quặng, môi trường lần IV</p>
        ...
        <section className="event-infor">
            ...
            <div className="row-event">
                ...
                <div className="box-event">
                    ...
                    <p className="name-event">Bác sĩ lâm sàng và súng :Chương trình giảng dạy về súng và thương tích do súng gây ra.</p>
                    </div>
                </div>  
                </div>
                <div className="col-event">
